...
function WritePostMobile() {
  return (
    ...
    >
      ...
      <button className='absolute bottom-[12px] right-[18px] px-[14px] h-[22px] rounded-[50px] bg-[#191A1A] text-white text-[12px] font-semibold whitespace-nowrap flex items-center'>
        글 작성하기
      </button>
    </div>
  );
