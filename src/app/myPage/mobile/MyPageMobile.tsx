        ...
        <>
          ...
          <div className='mobile-layout flex flex-col flex-grow items-center px-[10px] py-[20px] gap-[20px] mobile-scroll'>
            <div className='w-full h-[100px] bg-white rounded-[20px] p-[20px] flex justify-between items-center'>
              <div className='flex gap-[10px]'>
                ...
                <div className='flex flex-col justify-center gap-[1px]'>
                  <div className='flex items-center text-[16px] font-semibold text-gray-850'>
              ...
              <div
                className='w-[85px] h-[29px] rounded-[5px] bg-gray-100 text-gray-850 flex justify-center items-center p-[6px] text-[14px] font-semibold whitespace-nowrap cursor-pointer'
            ...
            <div className='flex w-full min-h-[176px] rounded-[20px] bg-white p-[20px] relative'>
              <div className='text-[18px] font-bold text-gray-850'>판결 승률</div>
              {userProfileData.memberProfileDTO.joinedResult === 0 ? (
                ...
                <>
                  ...
                  <div className='text-gray-500 text-[12px] absolute whitespace-nowrap font-[400] bottom-[23px] left-[50%] translate-x-[-50%]'>
            ...
            <div className='flex flex-col w-full min-h-[176px] p-[20px] rounded-[20px] gap-[15px] bg-white'>
              <div className='text-[18px] font-bold text-gray-850'>
            ...
            >
              <div className='text-[18px] font-bold text-gray-850'>판결 전적</div>
            ...
            >
              <div className='text-[18px] font-bold text-gray-850'>내가 쓴 글</div>
              <Image src={BackArrowIcon} alt='ArrowIcon' className='rotate-180' />
            </div>
            <div
              className='text-gray-500 text-[14px] font-medium mt-[39px] cursor-pointer'
