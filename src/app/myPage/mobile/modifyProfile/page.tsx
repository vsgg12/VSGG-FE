        ...
        <>
          ...
          <div className='mobile-layout h-[100dvh] flex flex-col items-center px-[21px] py-[20px] gap-[80px] pt-[40px]'>
            <div>
              ...
              <div className='flex flex-col gap-[10px] px-[25px]'>
                <div className='flex gap-3 items-center justify-center'>
                  <input
                    type='text'
                    className='w-[207px] h-[30px] px-[2px] font-medium text-[22px] bg-inherit text-[#555555] border-b-2 border-gray focus:outline-none'
                    value={nickName}
              ...
              <div className='flex gap-[15px] pl-[10px]'>
                ...
                <div className='flex flex-col justify-between'>
                  ...
                  <div className='flex gap-[10px]'>
                    ...
                    />
                    <button
                      className='border border-gray rounded-[5px] text-[#333333] bg-white w-[94px] h-[32px]'
                    ...
                    <button
                      className='border border-gray rounded-[5px] text-[#333333] bg-white w-[48px] h-[32px]'
            ...
            <div className='flex gap-[20px] justify-center'>
              <button
                className='rounded-[30px] w-[150px] h-[34px] justify-center items-center text-[#8A1F21] bg-white text-[20px] font-semibold border border-[#8A1F21]'
                onClick={() => router.back()}
              >
                취소
              </button>
              <button
                className='rounded-[30px] w-[150px] h-[34px] justify-center items-center bg-[#8A1F21] text-white text-[20px] font-semibold border border-[#8A1F21]'
                onClick={handleSave}
              >
                적용
              </button>
