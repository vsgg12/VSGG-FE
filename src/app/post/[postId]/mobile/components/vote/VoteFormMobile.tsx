...
export default function VoteFormMobile({ voteInfo, handleVoteSubmit, voteCount }: IVoteFormProps) {
  ...
  return (
    <div className='relative flex flex-col h-fit w-full items-center rounded-[20px] bg-[#ffffff] gap-[20px] m-['>
      <ChampionImgBox
