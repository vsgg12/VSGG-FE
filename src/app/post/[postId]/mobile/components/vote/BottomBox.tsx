...
import VotingGraphMobile from './VotingGraphVotingGraphMobile';
...
export default function BottomBox({
  ...
  return (
    <div className='flex flex-col gap-[10px] relative items-center w-full'>
      <Image
        src={isHamburgerClicked ? Icon_Hamburger_activated : Icon_Hamburger}
        width={26}
        height={26}
        alt='hamburger'
        className='cursor-pointer relative self-end'
        onClick={() => {
      ...
      <div className='flex w-full'>
        {isHamburgerClicked ? (
          ...
          <div className='flex flex-col items-center w-full'>
            <div className='p-content-s-mb flex w-full'>
              <VotingGraphMobile />
            </div>
