...
export default function VoteFormMobile({ voteInfo, handleVoteSubmit }: IVoteFormProps) {
  ...
  return (
    <div className='relative flex flex-col w-full justify-around gap-[40px]'>
      ...
      <div className='flex flex-col justify-self-end mt-[20px]'>
        <button
          className='h-[30px] w-[80px] rounded-full bg-[#E20A29] text-[15px] text-white hover:bg-red-800 disabled:bg-[#ECECEC] disabled:text-[#828282]'
