      ...
      <main>
        ...
        <section className='flex justify-center'>
          <div className='w-4/5 max-w-[1400px]'>
                  ...
                  <div className='sticky top-[-1px] bg-[#ffffff] pb-[30px] pt-[44px]'>
                    ...
                    <div className='p-content-s-mb flex flex-row items-center justify-start font-medium'>
                      ...
                      <div>
                        ...
                        <div className='text-[12px] text-[#C8C8C8]'>2024-06-19</div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className='mb-[30px] border-l-2 border-[#8A1F21] pl-6'>
                          {commentData?.map((reply: any, index: any) => (
                            <div key={index} className='mb-[10px]'>
                              <PostComment postId={params.postId} comment={reply} />
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            <VoteForm setIsVoted={true} postId={params.postId} ingameInfos={ingameInfos} />

            {isVoted && <VoteResult postId={params.postId} ingameInfos={ingameInfos} />}
          </div>
        </section>
      </main>
    </>
