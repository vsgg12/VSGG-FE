  ...
  return (
    <>
      ...
      <div className='w-[684px] h-[256px] flex gap-[20px] bg-white'>
        <div
          className='w-[332px] h-full rounded-[10px] border-gray-150 border-[0.5px] flex flex-col items-center justify-between p-[15px] cursor-pointer hover:border-primary-500'
          onClick={onClickJudgeFault}
        >
          <div className={'font-bold text-[20px] text-gray-900'}>챔피언 판결</div>
          <img
            ...
            height={131}
          />
          <div className={'text-black text-[20px]'}>챔피언 별 과실을 선택하는 방식</div>
        </div>
        <div
          className='w-[332px] h-full rounded-[10px] border-gray-150 border-[0.5px] flex flex-col items-center justify-between p-[15px] cursor-pointer hover:border-primary-500'
          onClick={onClickJudgeChampion}
        >
          <div className={'font-bold text-[20px] text-gray-900'}>주장 판결</div>
          <img
            ...
            height={93}
          />
          <div className={'text-black text-[20px]'}>두 소환사의 주장 중 선택하는 방식</div>
        </div>
      </div>
    </>
  );
