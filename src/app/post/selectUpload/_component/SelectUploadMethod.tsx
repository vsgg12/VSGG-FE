  ...
  return (
    <>
      <div className='w-full h-[202px] flex flex-col gap-[40px] justify-center items-center'>
        ...
        <div className='text-[32px] font-bold text-[#222222]'>동영상 첨부 방법을 선택해주세요.</div>
      </div>
      ...
      <div className='w-full text-[12px] text-[#AAAAAA] text-center flex-col absolute bottom-[36px]'>
        <p>
