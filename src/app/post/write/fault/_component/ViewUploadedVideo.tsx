  ...
  return (
    <div className={'flex flex-col gap-[20px]'}>
      ...
      <div
        ...
        className={`w-[652px] max-h-[340px] rounded-[10px] ${getBoxClass()} ${videoBoxPbClass} pt-[10px] flex flex-col gap-[20px] justify-center items-center`}
      >
        <div
          className={
            'w-full h-full text-[18px] text-black flex flex-col justify-between items-center gap-[20px]'
          }
        >
          <div className={'w-full flex justify-between items-center'}>
            <div className={'flex gap-[5px]'}>
              {videoLink && <Image width={30} height={30} alt={'linkIcon'} src={linkIcon} />}
              <div>{uploadVideos ? uploadVideos.name : videoLink}</div>
            </div>
            <div
