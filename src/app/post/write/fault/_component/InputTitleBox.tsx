  ...
  return (
    <div className={'flex flex-col gap-[20px]'}>
      ...
      <input
        ...
        className={`w-[652px] h-[64px] text-[20px] rounded-[10px] px-4 outline-none border-semantic-border-default focus-within:border-[1px] focus-within:border-primary-500 ${boxBase}`}
      />
    </div>
  );
};
