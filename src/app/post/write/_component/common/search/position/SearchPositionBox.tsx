      ...
      {!open && (
        <div
          ...
          className='
            ...
            bg-white border-[0.5px] border-gray-150
            hover:shadow-md
        ...
        >
          {selectedPosition ? (
            <>
              ...
              <span className='text-[16px] text-gray-850'>{selectedPosition.content}</span>
            </>
          ) : (
            <>
              <Image src={graySearchIcon} alt='searchIcon' width={28} height={28} />
              <span className='text-[16px] text-gray-400'>포지션 검색</span>
            </>
          )}
        </div>
      )}
          ...
          <div className='flex flex-col gap-[5px] px-[10px] pb-[10px]'>
            {filteredPositions.map((item) => {
              ...
              return (
                ...
                >
                  {item.svgB}
                  <span className='text-[16px] text-gray-850'>{item.content}</span>
                </div>
              );
            })}
