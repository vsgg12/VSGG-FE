  ...
  return (
    <div className='w-full h-[100dvh] bg-white'>
      ...
      <div className='mobile-layout flex flex-col pt-[20px] px-[16px] mobile-scroll !bg-white'>
        {/* 검색창 */}
        <div className='w-full h-[40px] flex items-center justify-between px-[20px] rounded-[10px] bg-gray-20 mb-[20px]'>
          <input
            className='flex-1 bg-transparent outline-none text-[16px] text-gray-850'
        ...
        {visiblePosts.length > 0 && keyword && (
          <p className='text-[16px] font-medium text-gray-850 mb-[20px]'>
            <span className='text-primary-500'>{keyword}</span>에 대한 검색 결과입니다.
          </p>
        )}
        ...
        {visiblePosts && visiblePosts.length > 0 ? (
          ...
          <div className='text-[12px] text-gray-500 w-full flex justify-center'>
            검색 결과가 없습니다
          </div>
        )}
      </div>
