...
function ModifyProfileHeader({ handleSaveClick }: { handleSaveClick: () => void }) {
  ...
  return (
    <div className='flex px-[10px] py-[20px] h-[50px] items-center mobile-layout sticky top-0 z-[40] justify-between'>
      ...
      />
      <div className='text-primary-500 font-bold text-[22px]'>프로필 수정</div>
      <div className='text-primary-500 font-semibold text-[18px] cursor-pointer' onClick={handleSaveClick}>완료</div>
    </div>
  );
}
