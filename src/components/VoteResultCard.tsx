...
const VoteResultCard: React.FC<Props> = ({ name, value, position }) => {
  return (
    <div className='flex bg-gray-20 border-1 border-gray-100 h-[46px] w-[172px] absolute left-[230px] top-[70px] gap-[10px] p-[10px] items-center'>
      <p className='text-primary-500 text-[12px] flex items-center'>과실 {value}</p>
